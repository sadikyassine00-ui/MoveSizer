...
export function LoadManifestModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/80 backdrop-blur-sm print:p-0 print:bg-white print:static">
      {/* Modal Card */}
      <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-lg bg-[#111318] border border-[#1F242F] text-zinc-100 p-5 sm:p-7 print:border-none print:max-w-none print:max-h-none print:p-0 print:text-black print:bg-white">
        {/* Print Header Bar (Hidden during print) */}
        <div className="flex items-center justify-between pb-3.5 mb-5 border-b border-[#1F242F] print:hidden">
        ...
        <div className="space-y-6 print:space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-[#090A0C] p-3.5 rounded-md border border-[#1F242F] print:bg-zinc-50 print:border-zinc-300 print:text-black">
            <div>
          ...
          <div>
            <div className="flex items-center gap-1.5 text-xs font-semibold text-white print:text-black uppercase tracking-wider mb-2.5">
              <Package className="w-4 h-4 text-[#FF5500]" strokeWidth={1.5} />
          ...
          <div>
            <div className="flex items-center gap-1.5 text-xs font-semibold text-white print:text-black uppercase tracking-wider mb-2.5">
              <Layers className="w-4 h-4 text-[#0066FF]" strokeWidth={1.5} />
              <span>4-Phase Commercial Loading Sequence</span>
            </div>

            <div className="space-y-2 text-xs">
              <div className="p-3 bg-[#090A0C] border border-[#1F242F] rounded-md print:border-zinc-300 print:bg-white">
